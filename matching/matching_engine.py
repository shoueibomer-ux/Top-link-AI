...
CATEGORY_TAXONOMY = {
    ...
    "general-maintenance": ["handyman", "maintenance", "odd job", "small repair", "fix up"],
    ...
    "cleaning-services": ["cleaning", "cleaner", "housekeeping", "maid", "deep clean", "move-out clean"],
    "moving-services": ["moving", "movers", "relocation", "packing", "move-in", "move-out"],
    "furniture-assembly": ["furniture assembly", "assemble furniture", "flat pack", "ikea"],
    "home-repair": ["home repair", "fix", "repair", "household repair"],
    "mechanic-services": ["mechanic", "car repair", "auto repair", "brakes", "oil change", "engine"],
    "car-wash": ["car wash", "auto detailing", "detailing", "wax"],
    "tire-repair": ["tire", "flat tire", "tire rotation", "tire balancing"],
    "towing-services": ["towing", "tow truck", "roadside assistance", "vehicle recovery"],
    "accounting-services": ["accounting", "accountant", "bookkeeping", "tax", "payroll"],
    "marketing-services": ["marketing", "advertising", "social media", "branding", "seo"],
    "website-design": ["website", "web design", "web developer", "e-commerce site"],
    "it-services": ["it support", "network", "computer repair", "tech support", "it services"],
    "photography": ["photographer", "photography", "photo shoot", "portrait"],
    "event-decoration": ["event decor", "decoration", "balloon", "floral arrangement"],
    "event-planning": ["event planning", "event planner", "wedding planner", "party planning"],
    "sound-lighting": ["sound system", "lighting rental", "dj equipment", "av rental"],
    "barber-services": ["barber", "haircut", "beard trim"],
